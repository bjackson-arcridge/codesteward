...
/packages/vscode/package.json -- for vs code plugin
package.json -- for CLI

If tweaking/updating existing functionality or fixing bugs, increment the patch
If adding/removing functionality, increment the minor version
Major version is managed by user instructions only

Currently the versions are managed independently
