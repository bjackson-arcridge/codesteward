...
description: Store detailed research gathered while fixing a bug or preparing a feature, especially API signatures, parameters, protocol details, and other facts agents are likely to hallucinate or misremember.
---

# remember-research

Use this skill after doing concrete research that should remain available to future agents but is too long or specific for a Decision Record.
