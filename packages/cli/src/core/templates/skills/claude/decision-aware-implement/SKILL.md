...
- If operating against a spec, cite the spec id/title in updates and keep implementation decisions, interface and structure changes, open questions, work logs, and test results current.
