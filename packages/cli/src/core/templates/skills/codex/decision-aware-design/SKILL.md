...
description: Consult accepted CodeSteward Decision Records before consequential Codex design work. Trigger for architecture, workflow, API, UI, or governance design choices that need project precedent; propose terse DR candidates when the design establishes durable guidance.
---
